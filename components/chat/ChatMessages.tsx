                    ...
                    <div className="flex flex-col items-start mb-6 group">
                      ...
                      >
                        ...
                        {message.satsSpent !== undefined &&
                          message.satsSpent > 0 && (
                            <div className="flex items-center gap-1.5 text-xs text-yellow-500/90 bg-yellow-500/10 border border-yellow-500/20 rounded-md px-3 py-1.5 transition-colors mr-2 select-none">
                              <svg
                                width="16"
                                height="16"
                                viewBox="0 0 24 24"
