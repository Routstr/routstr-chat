...
export const handlers = [
  ...
  http.get('https://mint.minibits.cash/Bitcoin/v1/keys/00500550f0494146', async ({ request }) => {
    const scenario = getScenario(request);
